...
const CourseCard = () => {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-4 border border-red-400 py-3">
      ...
      <div className=" flex w-full items-center justify-between border border-blue-400 px-5">
